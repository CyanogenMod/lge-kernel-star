...
/* jay.sim */
#define AMI304_IOCTL_I2C_READ				_IOR(AMI304MIDIO, 0x09, char[200])
#define AMI304_IOCTL_I2C_WRITE				_IOW(AMI304MIDIO, 0x0A, char[200])
#define AMI304_IOCTL_MAGNETIC_RAW			_IOW(AMI304MIDIO, 0x0B, int[5])
