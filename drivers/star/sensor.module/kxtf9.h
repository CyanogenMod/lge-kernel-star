...
/* jay.sim */
//#define KXTF9_IOCTL_MAGNETIC_RAW   _IOWR(KXTF9_IOCTL_BASE, 0x0A, short)
#define KXTF9_IOCTL_ACCEL_RAW	   _IOWR(KXTF9_IOCTL_BASE, 0x0B, int[5])
#define KXTF9_IOCTL_I2C_READ	   _IOWR(KXTF9_IOCTL_BASE, 0x0C, char[200])
#define KXTF9_IOCTL_I2C_WRITE	   _IOWR(KXTF9_IOCTL_BASE, 0x0D, char[200])
#define KXTF9_IOCTL_ACCEL_COMPASS_SLEEP_MODE	_IOWR(KXTF9_IOCTL_BASE, 0x0E, short)
#define KXTF9_IOCTL_ACCEL_COMPASS_SLEEP_WAKE_UP	_IOWR(KXTF9_IOCTL_BASE, 0x0F, short)
/**/

#define KXTF9_I2C_ADDR		0x0F
/* CONTROL REGISTER 1 BITS */
#define KXTF9_RES_12BIT		0x40
#define KXTF9_G_2G 		0x00
#define KXTF9_G_4G 		0x08
#define KXTF9_G_8G 		0x10
#define KXTF9_SHIFT_ADJ_2G		4
