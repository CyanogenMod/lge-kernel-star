...
#else /* for NOT  CONFIG_WIFI_CONTROL_FUNC */
	...
	switch (onoff) {
		case WLAN_RESET_OFF:
			WL_TRACE(("%s: call customer specific GPIO to insert WLAN RESET\n",
				__FUNCTION__));
#if defined(CONFIG_LGE_BCM432X_PATCH)
		printk("[Wi-Fi] WLAN_RESET_OFF : %d\n",	gpio_get_value(TEGRA_GPIO_PM3));
		gpio_set_value(TEGRA_GPIO_PM3, 0);
		printk("[Wi-Fi] WLAN_RESET_OFF : %d\n",	gpio_get_value(TEGRA_GPIO_PM3));
#endif
		...
		case WLAN_RESET_ON:
			WL_TRACE(("%s: callc customer specific GPIO to remove WLAN RESET\n",
				__FUNCTION__));
#if defined(CONFIG_LGE_BCM432X_PATCH)
		printk("[Wi-Fi] WLAN_RESET_ON : %d\n",	gpio_get_value(TEGRA_GPIO_PM3));
		gpio_set_value(TEGRA_GPIO_PM3, 1);
		mdelay(200);
		printk("[Wi-Fi] WLAN_RESET_ON : %d\n",	gpio_get_value(TEGRA_GPIO_PM3));
#endif
#ifdef CUSTOMER_HW
