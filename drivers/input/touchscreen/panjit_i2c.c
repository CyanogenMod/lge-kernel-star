...
static int pj_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	input_set_abs_params(touch->input_dev, ABS_MT_POSITION_X, 0, 4095, 0,
			     0);
	input_set_abs_params(touch->input_dev, ABS_MT_POSITION_Y, 0, 4095, 0,
			     0);
