...
#ifdef CONFIG_LGE_USB_GADGET_DRIVER
			/* LGE_CHANGE
			 * Disable zlps in case of LG android USB and fsl_tegra udc.
			 * By this, host driver can handle null packet properly.
			 * 2011-06-01, hyunhui.park@lge.com
			 */
			ecm->port.is_zlp_ok = !(
...
//LGE_CHANGE_S  yongkyun.lee@lge.com 2011/6/5:  ==> 
...
//LGE_CHANGE_E  yongkyun.lee@ lge.com END ==> 
...
#if 0	//LGE_CHANGE  yongkyun.lee@ lge.com LINE ==> 
...
/* NOTE : if NOT defined */
	...
	//////////////////////////////////////
	//		dongho70.kim@lge.com for NDIS
	status = gether_setup(c->cdev->gadget, ethaddr); 
    /////////////////////////////////////
