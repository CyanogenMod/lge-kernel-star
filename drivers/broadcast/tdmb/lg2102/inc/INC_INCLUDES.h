...
typedef unsigned long			INC_DOUBLE32,		*INC_PDOUBLE32;	//inb612 double link error by inb612
...
/* Software version   : version 1.37                                             */
/* Software Update    : 2010.05.10                                               */
/*********************************************************************************/
#define INC_FW_VERSION		"T3700_v1.37"
...
#define INC_INTERRUPT_POLARITY_LOW					0x0000
#define INC_INTERRUPT_POLARITY_HIGH					0x8000
...
#define T3700_SCAN_IF_DELAY				400
#define T3700_SCAN_RF_DELAY				1500
#define T3700_PLAY_IF_DELAY				1000
#define T3700_PLAY_RF_DELAY				1500

#define INC_T3700_CHIP					3700
#define INC_T3700_CHIP_ID				0xC00
#define INC_T3700_RF_REGISTER_MAX		105
...
{
	INC_INT16			nSetCnt;
	INC_CHANNEL_INFO	astSubChInfo[MAX_SUBCH_SIZE];   //--> ? asj  //for android stack --> origin [MAX_SUBCH_SIZE];
...
typedef union _tagST_FEC{
	INC_UINT8 ucInfo;
	struct {
		INC_UINT8 bitFECFlag	:	2;
		INC_UINT8 bitSubChID	:	6;
	}ITEM;
}ST_FEC, *PST_FEC;
...
#define INC_FIFO_DEPTH    (1024*5)  //chunk sizeê°€ 64 FIFO overflow ë°œìƒ?˜ì—¬ 10->20 ë³€ê²?
...
{
	INC_UINT8	ucMsgGovernment;//¸Þ½ÃÁö ¹ß·É±â°ü
	INC_UINT8	ucMsgID;				//¸Þ½ÃÁö °íÀ¯¹øÈ£
	ST_DATE_T	stDate;					//ÀÏ½Ã

	INC_INT8	acKinds[4];			//Àç³­Á¾·ù
	INC_UINT8	cPrecedence;		//¿ì¼±¼øÀ§
	INC_UINT32	ulTime;				//Àç³­½Ã°£
	INC_UINT8	ucForm;					//Àç³­Áö¿ªÇü½Ä
	INC_UINT8	ucResionCnt;		//Àç³­ Áö¿ª¼ö
...
void        INC_CHIP_CTRL(INC_UINT8 ucI2CID);
...
INC_UINT8 INC_GET_ANT_LEVEL2(INC_UINT8 ucI2CID);
...
{
	INC_UINT16 uiStrength;
	INC_UINT16 uiSubID;
	INC_UINT16 uiZeroPad;
	INC_UINT16 uiPattern;
}ST_TII_INFO;
