...
//20110617 ws.yang@lge.com ..add to ip raw data [S]
#if defined(CONFIG_LU6500) || defined (CONFIG_LU8800)
#define TS0710_IP_RAW_DATA
#endif
//20110617 ws.yang@lge.com ..add to ip raw data [E]
...
//20110502 ws.yang@lge.com .. add to mux log [S]
//#define TS0710DEBUG 
#ifdef TS0710DEBUG
#define TS0710_DEBUG(fmt, arg...) printk("[MUX] : %s (%d line): " fmt "\n", __FUNCTION__, __LINE__, ## arg)
#else
#define TS0710_DEBUG(fmt...)
#endif

//#define TS0710_GPIO_LOG
#ifdef TS0710_GPIO_LOG
#define TS0710_GPIO_PRINTK(fmt, arg...) printk("[MUX] : %s (%d line): " fmt "\n", __FUNCTION__, __LINE__, ## arg)
#else
#define TS0710_GPIO_PRINTK(fmt, arg...)
#endif

#define TS0710_PRINTK(fmt, arg...) printk("[MUX] : %s (%d line): " fmt "\n", __FUNCTION__, __LINE__, ## arg)
//20110502 ws.yang@lge.com .. add to mux log [E]
