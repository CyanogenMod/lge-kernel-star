...
const struct tegra_pingroup_desc tegra_soc_pingroups[TEGRA_MAX_PINGROUP] = {
	...
	PINGROUP(SDMMC1_CLK,	  SDMMC1,   SDMMC1,	RSVD1,	    RSVD2,	INVALID,    RSVD,	INPUT,	0x3048),
	PINGROUP(SDMMC1_CMD,	  SDMMC1,   SDMMC1,	RSVD1,	    RSVD2,	INVALID,    RSVD,	INPUT,	0x304c),
	PINGROUP(SDMMC1_DAT3,	  SDMMC1,   SDMMC1,	RSVD1,	    UARTE,	INVALID,    RSVD,	INPUT,	0x3050),
	PINGROUP(SDMMC1_DAT2,	  SDMMC1,   SDMMC1,	RSVD1,	    UARTE,	INVALID,    RSVD,	INPUT,	0x3054),
	PINGROUP(SDMMC1_DAT1,	  SDMMC1,   SDMMC1,	RSVD1,	    UARTE,	INVALID,    RSVD,	INPUT,	0x3058),
	PINGROUP(SDMMC1_DAT0,	  SDMMC1,   SDMMC1,	RSVD1,	    UARTE,	INVALID,    RSVD,	INPUT,	0x305c),
	...
	PINGROUP(VI_D1,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3128),
	PINGROUP(VI_D2,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x312c),
	PINGROUP(VI_D3,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3130),
	PINGROUP(VI_D4,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3134),
	PINGROUP(VI_D5,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3138),
	PINGROUP(VI_D6,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x313c),
	PINGROUP(VI_D7,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3140),
	PINGROUP(VI_D8,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3144),
	PINGROUP(VI_D9,		  VI,	    INVALID,	SDMMC2,	    VI,		RSVD1,	    RSVD,	INPUT,	0x3148),
	...
	PINGROUP(SDMMC4_CLK,	  SDMMC4,   INVALID,	NAND,	    GMI,	SDMMC4,	    RSVD,	INPUT,	0x3258),
	...
	PINGROUP(CAM_MCLK,	  CAM,	    VI,		INVALID,    INVALID,	POPSDMMC4,  RSVD,	INPUT,	0x3284),
	...
	PINGROUP(KB_ROW6,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32d4),
	PINGROUP(KB_ROW7,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32d8),
	PINGROUP(KB_ROW8,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32dc),
	PINGROUP(KB_ROW9,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32e0),
	PINGROUP(KB_ROW10,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32e4),
	PINGROUP(KB_ROW11,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32e8),
	PINGROUP(KB_ROW12,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32ec),
	PINGROUP(KB_ROW13,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32f0),
	PINGROUP(KB_ROW14,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32f4),
	PINGROUP(KB_ROW15,	  SYS,	    KBC,	INVALID,    SDMMC2,	INVALID,    RSVD,	INPUT,	0x32f8),
	...
	PINGROUP(SDMMC3_CLK,	  SDMMC3,   UARTA,	PWM2,	    SDMMC3,	INVALID,    RSVD,	INPUT,	0x3390),
	PINGROUP(SDMMC3_CMD,	  SDMMC3,   UARTA,	PWM3,	    SDMMC3,	INVALID,    RSVD,	INPUT,	0x3394),
	PINGROUP(SDMMC3_DAT0,	  SDMMC3,   RSVD0,	RSVD1,	    SDMMC3,	INVALID,    RSVD,	INPUT,	0x3398),
	PINGROUP(SDMMC3_DAT1,	  SDMMC3,   RSVD0,	RSVD1,	    SDMMC3,	INVALID,    RSVD,	INPUT,	0x339c),
	PINGROUP(SDMMC3_DAT2,	  SDMMC3,   RSVD0,	PWM1,	    SDMMC3,	INVALID,    RSVD,	INPUT,	0x33a0),
	PINGROUP(SDMMC3_DAT3,	  SDMMC3,   RSVD0,	PWM0,	    SDMMC3,	INVALID,    RSVD,	INPUT,	0x33a4),
	PINGROUP(SDMMC3_DAT4,	  SDMMC3,   PWM1,	INVALID,    SDMMC3,	INVALID,    RSVD,	INPUT,	0x33a8),
	PINGROUP(SDMMC3_DAT5,	  SDMMC3,   PWM0,	INVALID,    SDMMC3,	INVALID,    RSVD,	INPUT,	0x33ac),
	PINGROUP(SDMMC3_DAT6,	  SDMMC3,   SPDIF,	INVALID,    SDMMC3,	INVALID,    RSVD,	INPUT,	0x33b0),
	PINGROUP(SDMMC3_DAT7,	  SDMMC3,   SPDIF,	INVALID,    SDMMC3,	INVALID,    RSVD,	INPUT,	0x33b4),
